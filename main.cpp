...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Blue Teapot with Zoom", nullptr, nullptr);
    if (!window) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        cameraDistance = glm::clamp(cameraDistance, 1.5f, 15.0f);
